      ...
      const handleVisibilityChange = () => {
        if (document.hidden) {
          setTabSwitchCount((prev: number) => {
            ...
            if (newCount === 1) {
              message =
                "⚠️ Warning 1: Switching tabs is not allowed. This is your first warning.";
            } else if (newCount === 2) {
              message =
                "⚠️ Warning 2: One more tab switch will automatically submit your quiz!";
            } else if (newCount >= 3) {
              message =
                "❌ Maximum violations reached. Your quiz will be submitted now.";
  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="max-w-2xl mx-auto">
        ...
        {showTabWarning && (
          <div
            className={`mb-4 rounded-lg p-4 flex items-start gap-3 border-l-4 animate-pulse ${
              tabSwitchCount >= 3
            ...
            <div className="flex-1">
              ...
              {tabSwitchCount === 1 && (
                <p className="text-sm text-orange-700 mt-1">
                  Switching tabs during quiz is prohibited. You have 2 more
                  violations before auto-submission.
                </p>
              )}
              {tabSwitchCount === 2 && (
                <p className="text-sm text-yellow-700 mt-1">
                  🚨 One more tab switch will trigger automatic quiz submission
                  with all current answers!
                </p>
              )}
            </div>
          </div>
